...
public:
	...
	void	GetItemImage( CTreeListItem const* pItem, int& nImage, 
		int& nExpandImage, int& nSelectedImage, int& nExpandSelectedImage ) const;
	void	SetItemImage( CTreeListItem* pItem, int nImage, 
		int nExpandImage, int nSelectedImage, int nExpandSelectedImage ) ;
	...
	int		GetCheck( CTreeListItem const* pItem ) const;
	void	SetCheck( CTreeListItem* pItem, bool bCheck = true ) ;

	int		GetLock( CTreeListItem const* pItem ) const;
	...
	void	ShowLockBox(CTreeListItem *pItem, bool bShow = true) ;
