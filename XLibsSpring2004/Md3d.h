...
DWORD d3dGetFreeTexMem();
DWORD d3dGetUsedTexMem();
...
MD3DERROR d3dPartitionTextureCache( DWORD dwCount, MD3DCACHESLOTPROFILE *lpProfile );
...
BOOL d3dIsTextureFormatSupported( DWORD );
...
#define MD3D_BACKBUFFER    0x00000002 // Create and use a backbuffer
#define MD3D_ZBUFFER       0x00000004 // Create and use a zbuffer
#define MD3D_DEBUGMODE	   0x00000008 // Debug mode
...
void __d3dDumpAllRenderStates( DWORD dwDebugLevel, DWORD dwFlags, LPDIRECT3DDEVICE3 lpd3dDev );
...
// Dump TSS state 
void __d3dDumpAllTSStates( DWORD dwDebugLevel, DWORD dwFlags, LPDIRECT3DDEVICE3 lpd3dDev );
