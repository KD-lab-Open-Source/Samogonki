...
class BodyFactory : hash_map<const char*, PtrHandle<GeneralBodyCreator>, hash<const char*>, eqstr>
{
	typedef hash_map<const char*, PtrHandle<GeneralBodyCreator>, hash<const char*>, eqstr> HashMap;
public:
	BodyFactory();
