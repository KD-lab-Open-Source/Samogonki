...
float evolve_time_step = 7.e-002f;
float real_time_to_evolve_time = 5.4f;
float Gravity = 25.f;
float Density = 1.e-004f;
...
float free_linear_damping = 5.e-002f;
...
float velocity_to_damage_factor = 1.e-002f;
float press_reaction_force_threshould = 0.5f;
float minimal_volume_level = 0.1f;
float archimedean_force_wave_time_factor = 5.e-003f;
float archimedean_force_wave_distance_factor = 8.e-002f;
float archimedean_force_wave_phase = 1.8f;
float archimedean_force_damping = 0.1f;
float triangle_clip_epsilon = 1.e-002f;
float get_placement_pose_water_dz = -5.f;
int rest_system_enabled = 0;
float rest_force2_threshould = 1.e-007f;
float rest_torque2_threshould = 1.e-007f;
float rest_velocity2_threshould = 5.e-002f;
float rest_angular_velocity2_threshould = 5.e-002f;
int constraint_impulse_calculation = 2;
float impulse_resolve_velocity_threshould = 1.e-002f;
float velocity_relaxation_value = 1.e-002f;
int constraint_force_calculation = 0;
float force_resolve_acceleration_threshould = 1.e-002f;
float acceleration_relaxation_value = 1.e-002f;
float penetration2acceleration_relaxation_factor = 1.e-002f;
float impact_friction_factor = 1.f;
float dynamic_friction_factor = 0.2f;
float static_friction_factor = 0.4f;
float VelocityZeroThreshould = 1.e-003f;
float MinDynamicFrictionVelocity = 0.5f;
float AccelerationZeroThreshould = 1.e-004f;
float FrictionZeroThreshould = 1.e-002f;
...
float CollisionHandlerVelocityTolerance = 1.e-002f;
float CollisionHandlerPenetrationTolerance = 1.e-002f;
