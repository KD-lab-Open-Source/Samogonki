...
enum eModeGraph3d
{
	...
	GRAPH3D_MODE_DEBUG	=	1<<1,	// ���������� ������
	GRAPH3D_MODE_WINDOW	=	1<<2,	// ����� � ����
	
	GRAPH3D_MODE_RGB16	=	1<<10,	// 16 ������ ����
	GRAPH3D_MODE_RGB32	=	1<<11,	// 32 ������ ����
	GRAPH3D_MODE_Z16	=	1<<12,	// 16 ������ z-������
	GRAPH3D_MODE_Z32	=	1<<13,	// 32 ������ z-������
	GRAPH3D_MODE_T16	=	1<<14,	// 16 ������ ��������
	GRAPH3D_MODE_T32	=	1<<15	// 32 ������ ��������
};
...
enum eMaterialMode
{
	...
	// ��������� ��������� Diffuse & Texture1 & Specular & Alpha
