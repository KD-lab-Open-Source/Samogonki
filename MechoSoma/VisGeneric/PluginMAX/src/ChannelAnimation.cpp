...
/*
sChannelAnimation& sChannelAnimation::operator = (const sChannelAnimation &Channel)
{
	Release();
	ID=Channel.ID;
	name=Channel.name;
	ObjectLibrary=Channel.ObjectLibrary;
	MaterialLibrary=Channel.MaterialLibrary;
	return *this;
}
*/