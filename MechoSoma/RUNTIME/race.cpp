...
{
	set_traction_by_distance = fl;	// зависимость от рассто€ни€ между семенами
	traction_modulation = v;	// 0..2 - модул€ци€ т€ги
}

void mchRacer::GetTractionPrm(int& fl,float& v)
{
	fl = set_traction_by_distance;	// зависимость от рассто€ни€ между семенами
	v = traction_modulation;	// 0..2 - модул€ци€ т€ги
}
