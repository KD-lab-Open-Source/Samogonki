...
/*
    ...
    Vertex attribute locations for vertex shader 'back_buffer_vs':
...
*/
static const char back_buffer_vs_source_glsl330[459] = {
...
static inline const sg_shader_desc* back_buffer_shader_desc(sg_backend backend) {
  if (backend == SG_BACKEND_GLCORE33) {
    ...
    if (!valid) {
      valid = true;
      desc.vs.source = back_buffer_vs_source_glsl330;
      desc.vs.entry = "main";
