...
//@caiiiycuk: Unknow word is used
/* Priv */ /* dbtype3ds - Database type settings */
/* Priv */ typedef enum
/* Priv */ {
/* Priv */    UnknownFile,      /* Database has not be created yet */
...
void AddToNameList3ds(namelist3ds **list_, char3ds *name);
...
void InitBitmap3ds(bitmap3ds *map_);
...
void GetMaterialNameList3ds(database3ds *db, namelist3ds **list_);
...
void GetMeshNameList3ds(database3ds *db, namelist3ds **list_);
...
void GetOmnilightNameList3ds(database3ds *db, namelist3ds **list_);
void GetSpotlightNameList3ds(database3ds *db, namelist3ds **list_);
...
void GetCameraNameList3ds(database3ds *db, namelist3ds **list_);
...
void GetCameraNodeNameList3ds(database3ds *db, namelist3ds **list_);
...
void DumpMapInfo3ds(FILE *out, mapinfo3ds *map_, long3ds dumplevel);
void DumpMesh3ds(FILE *out, mesh3ds *mesh, long3ds dumplevel);
void DumpMaterial3ds(FILE *out, material3ds *mat, long3ds dumplevel);
void DumpBitmap3ds(FILE *out, bitmap3ds *map_, long3ds dumplevel);
